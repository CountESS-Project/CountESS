...
from countess.core.config import read_config_dict, write_config, write_config_node_string, export_config_graphviz
...
def test_read_config_dict():
    ...
    pn = read_config_dict('node', '.', {
        '_module': __name__,
        '_class': 'NothingPlugin',
        'foo': '"bar"'
    })
    assert pn
